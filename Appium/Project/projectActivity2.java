...
//        URL serverURL = new URI("http://localhost:4723").toURL();
    ...
    public void addTask1() {
    	WebElement task =driver.findElement(AppiumBy.xpath("(//android.widget.TextView[@resource-id='com.app.todolist:id/tv_exlv_task_name'])[1]"));
    	task.click(); 
    	ActionsLongPressBase.doLongPress(driver, start, end, 1500)
